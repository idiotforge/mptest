    ...
    // ts pmo
    	...
    	switch _data {
    		...
    		case messages.playerdata:
                ...
                var _xs = buffer_read(_buffer, buffer_s8)
            
                var _spr = buffer_read(_buffer, buffer_u16)
                var _img = buffer_read(_buffer, buffer_u8)
                ...
                if instance_exists(client_insts[_sock]) && client_insts[_sock].object_index == obj_otherplayer {
                    ...
                    client_insts[_sock].image_xscale = _xs
                    client_insts[_sock].sprite_index = _spr
                    client_insts[_sock].image_index = _img
                }
                ...
                if is_server {
                    ...
                    buffer_write(_data, buffer_s8, _xs)
                    
                    buffer_write(_data, buffer_u16, _spr)
                    buffer_write(_data, buffer_u8, _img)
